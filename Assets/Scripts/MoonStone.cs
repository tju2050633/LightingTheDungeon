...
namespace LightingTheDungeon
{
    public class MoonStone : MonoBehaviour
    {
        ...
        //��ʼλ��
        public Vector3 addPosition = new Vector3(0.25f, 0, 0);
        //���ù��߿���
        ...
        void CasetLaser()
        {
            ...
            for (int i = 0; i < times; i++)
            {
                ...
                else if (hitInfo.collider.tag == "SunStone")
                {
                    SunStone sunStone = hitInfo.collider.GetComponent<SunStone>();
                    sunStone.boolean = true;
                    sunStone.FixedUpdate();
                    return;
                }
